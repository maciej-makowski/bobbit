 ...
 * `resolveContainerRuntime(store)` reads the project's `sandbox_runtime` config
 * (via `ProjectConfigStore.getSandboxRuntime()`) and never throws — unknown,
 * empty, or missing values fall back to Docker.
 *
