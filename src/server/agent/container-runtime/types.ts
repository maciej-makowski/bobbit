...
/** Provider id, derived from the single `sandbox` mode (`podman` → podman, else docker). */
...
export interface ContainerRuntime {
	...
	/**
	 * Optional actionable hint appended to availability errors when this runtime
	 * is selected but unreachable (e.g. Podman rootless/SELinux/`info` schema
	 * gotchas). Returns `undefined` when there is nothing runtime-specific to add.
	 */
