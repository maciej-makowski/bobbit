// v2-native — ported from fork tests/multi-gateway-validation.test.ts (node:test → vitest).
// Pins saveGateways() name-validation + aigw-singleton constraints.
...
import { saveGateways, listGateways } from "../../src/server/agent/aigw-manager.js";
