// v2-native — ported from fork tests/multi-gateway-migration.test.ts (node:test → vitest).
// Pins the idempotent boot-time legacy `aigw.url` → `modelGateways` migration.
...
import { migrateGatewayPrefs, listGateways } from "../../src/server/agent/aigw-manager.js";
