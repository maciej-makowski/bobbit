...
# --- 2. Probe host Node >= 20 (fail loudly with remediation) ---------------
NODE_BIN=""
...
============================================================================
 ...
 NOTE: verify edge-TLS coverage for the chosen hostname FIRST — a 2nd-level
 subdomain like bobbit.z13.maciej.dev is NOT covered by free Universal SSL on a
 full-setup zone. See docs/cloudflare-tunnel.md.
============================================================================
EOF
